...
#ifndef _Included_com_nd_media_amr_AmrDecoder
#define _Included_com_nd_media_amr_AmrDecoder
...
JNIEXPORT void JNICALL Java_com_nd_media_amr_AmrDecoder_init
  (JNIEnv *, jclass) {
  if(decode_init ++ != 0){
          return;
  }
...
JNIEXPORT void JNICALL Java_com_nd_media_amr_AmrDecoder_exit
  (JNIEnv *, jclass) {
  if(!decode_init){
          return;
   }
...
JNIEXPORT jint JNICALL Java_com_nd_media_amr_AmrDecoder_decode
