...
#ifndef _Included_com_nd_media_amr_AmrEncoder
#define _Included_com_nd_media_amr_AmrEncoder
...
JNIEXPORT void JNICALL Java_com_nd_media_amr_AmrEncoder_init
...
JNIEXPORT void JNICALL Java_com_nd_media_amr_AmrEncoder_exit
  (JNIEnv *, jclass) {
    if(!initialized){
        return;
    }
...
JNIEXPORT void JNICALL Java_com_nd_media_amr_AmrEncoder_reset
  (JNIEnv *, jclass) {
    if(!initialized){
        return;
    }
